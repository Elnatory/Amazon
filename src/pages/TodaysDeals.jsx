    ...
    <div className='container '>
      <div className='row flex catbackground'>
        ...
        <div className="col-lg-2  ">
          <div className="text-lg font-bold mx-2">Any Department </div>
        ...
        <div className=''> 
             <h1 className='fs-2 fw-bold mb-2'> Today's Deals </h1>

                  <p className='phcategory1'>Enjoy FREE delivery, exclusive deals, <span className='text-black'>Today's Deals</span> and more Join today. Cancel anytime.</p>
        ...
        <div className="col-lg-10 mx-auto  h-25 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 xl:gap-7  ">
