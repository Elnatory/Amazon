...
const SearchResultBox = ({ result }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center align-middle">
        {imageCover && (
          <img
            src={imageCover}
            alt={title}
            className="max-w-full h-60 object-cover mb-4"
          />
        )}
      </div>
      ...
      <h3 className="mb-2">
        Product Brand : <span className="text-lg">{brand.name}</span>
      </h3>
      ...
      <div className="flex items-center mb-2">
        ...
        />
        &nbsp; &nbsp;
        <span className="text-md">{ratingsQuantity} (Customer review)</span>
      </div>
