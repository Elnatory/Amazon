  ...
  return (
    ...
    <div className='container '>
      <div className='row flex catbackground'>
        ...
        <div className=''> 
             <h1 className='fs-2 fw-bold mb-2'>  Amazon Hot New Releases </h1>
             <hr />

                  <p className='phcategory1'>Enjoy FREE delivery, exclusive deals, <span className='text-black'> Amazon Hot New Releases </span> and more Join today. Cancel anytime.</p>
        ...
        <div className="col-lg-10 mx-auto  h-25 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 xl:gap-7 p-4 ">
         ...
         product.updatedAt && product.updatedAt.substring(0, 10) !== 0 ? (
                  ...
                  <div className="product-price text-sm text-gray-600 font-semibold">
                    {product.updatedAt ? (
                      <>
                        ...
                        <span className="curr-price" content={product.updatedAt}>
                          {(product.updatedAt.substring(0,10))}
                        </span>
                      </>
                    ) : (
                      <span className="curr-price" content={product.updatedAt.substring(0,10)}>
                        {(product.updatedAt.substring(0,10))}
                      </span>
                    )}
                  </div>
