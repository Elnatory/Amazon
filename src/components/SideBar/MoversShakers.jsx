...
import {abdu2} from '../../assets/index'
...
useEffect(() => {
  ...
  return (
    ...
    <div className='container   '>
      <div className='row flex h-25 catbackground'>
...
<div className=''> 
     <h1 className='fs-2 fw-bold mb-2 '>  Amazon Movers & Shakers </h1>
<hr />
          <p className='phcategory1'>Enjoy FREE delivery, exclusive deals, <span className='text-black'> Amazon Movers & Shakers </span> and more Join today. Cancel anytime.</p>
          <img className="mb-2" src={abdu} alt="" />
          <img className="mb-2" src={abdu2} alt="" />
        ...
        <div className="col-lg-10 mx-auto  h-25 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 xl:gap-7 p-4 ">
         ...
         product.quantity && product.quantity >= 200 ? (
                  ...
                  <div className="product-price text-sm text-gray-600 font-semibold">
                    {product.updatedAt ? (
                      <>
                        ...
                        <span className="curr-price" content={product.quantity}>
                          {(product.quantity)}
                        </span>
                      </>
                    ) : (
