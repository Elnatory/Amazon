    ...
    <>
      <div className="w-full column p-3 mb-3">
        ...
        <input
          ...
          type="checkbox"
          id="fullfilledByAmazon"
          name="fullFilledByAmazon"
        />
        <label
          className="hover:text-orange-600 check-label ml-3"
          htmlFor="fullfilledByAmazon"
        >
          {" "}
        ...
        >
          ...
          <p>All customers get FREE Shipping on orders shipped by Amazon</p>
        </label>
